    ...
    <section className="py-14">
      <div className="max-w-screen-xl mx-auto px-4 text-gray-600 gap-12 md:px-8 lg:flex">
        <div className="max-w-md">
          ...
          <p className="mt-3">
            Richie.js is powered by a vibrant community of developers. Whether
            you're troubleshooting, contributing, or staying updated, we've got
