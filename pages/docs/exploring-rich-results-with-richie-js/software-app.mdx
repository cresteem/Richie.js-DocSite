...
<Callout>If you have a list of OS, separators should be a comma (,)</Callout>
...
```html showLineNumbers copy filename="software-app.html" /1-aggrate/ /"arv"/ /"mr"/ /"rc"/ {3-16}
<div>
...
<Callout>Currency should be the `alpha-3` code.</Callout>
