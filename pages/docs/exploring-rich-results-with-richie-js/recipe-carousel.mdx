...
### 2. **URL** (`rjs-recipe-[number]`)

```html copy filename="recipe.html" /id="rjs-recipe-1">/
<div id="rjs-recipe-1">....</div>
```

### 3. **Thumbnail** (`rjs-recipe-[number]-img`)
...
<!-- pth - means hours-->
<p class="rjs-recipe-1-pth">1 hour</p>
<!-- OR -->
...
### 9. **Cooking time** (`rjs-recipe-[number]-ctm`, `rjs-recipe-[number]-cth`, `rjs-recipe-[number]-cthm`)

```html copy filename="recipe.html" /cth/ /ctm/ /cthm/
<!-- ctm - means minutes-->
<p class="rjs-recipe-1-ctm">25 minutes</p>
<!-- OR -->

<!-- cth - means hours-->
<p class="rjs-recipe-1-cth">1 hour</p>
<!-- OR -->
...
### 10. **Keywords** (`rjs-recipe-[number]-kw`)
...
### 14. **Aggregated rating** (`rjs-recipe-[number]-aggrate`)
...
### 15. **Ingredients** (`rjs-recipe-[number]-ingredient`)
...
### 16. **Instructions** (`rjs-recipe-[number]-instructions`)

<Callout type='warning'>Each step instance `<div>` must have `id` for making deep-link / internal link. like line 4 and 18 in below.</Callout>
...
<div class="rjs-recipe-1-instructions">
  ...
  <div class="step" id="step1">
    ...
    <p class="long">
      Rinse 2 cups of basmati rice under cold water until..
      <!-- shortened for brevity -->
    </p>
  </div>
  ...
  <div class="step" id="step2">
    ...
    <p class="long">
      Marinate 500 grams of meat...
      <!-- shortened for brevity -->
    </p>
  </div>

  <!-- add number of step instances as you need -->
</div>
<!-- INSTRUCTIONS OVER -->
```

### 17. **Video** (`rjs-recipe-[number]-vframe`)

<Callout type="info">Use YouTube Embed Video</Callout>

```html copy filename="recipe.html" /vframe/
<iframe
  class="rjs-recipe-1-vframe"
  width="560"
  height="315"
