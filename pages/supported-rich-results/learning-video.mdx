...
### 2. Segment index
<Callout>Time stamp of beginning of each segment should be set using `data-offset` attribute. Where value is number of seconds.</Callout>
...
<Callout type="info">Any number of video instance can be added in single page</Callout>
