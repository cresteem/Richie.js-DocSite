...
<Callout> Range seperator should be Hyphen(-) in between days and times</Callout>
...
### 12. URL (Website)
<Callout>URL would be deeplink of entity so ID is mandatory in parent wrapper.</Callout>
